...
courseMenu.CourseMenu.prototype =
{
  ...
  if ( this.detailViewLink && this.detailViewLink2 )
  {
	Event.observe( this.detailViewLink, 'click', this._detailViewExpandAll.bindAsEventListener( this ) );
	Event.observe( this.detailViewLink2, 'click', this._detailViewCollapseAll.bindAsEventListener( this ) );
 ...
 */
  deleteItem: function( toc_id )
  {
    ...
    new Ajax.Request( this.appendMenuActionUrl( 'cmd=getTocRemoveMessage&course_id='+course_id+'&toc_id='+toc_id ), {
    onSuccess: function(transport, json) {
      ...
      if ( result.success == "true" )
      {
        ...
        {
          var removeTocUrl = appendQueryStringFunc( result.actionUrl, "cmd=removeToc&course_id=" + course_id +
